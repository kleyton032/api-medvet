...
<a href="${link}/v1/api/usuario/senha-recuperada?token=${recovery.token}">
    ${link}/v1/api/usuario/senha-recuperada?token=${recovery.token}
</a>
<br /><br /><hr />
<p>
...
<br />
<p>Atenciosamente, Med-Vet</p>`;

const opcoesEmail = {
    from: "naoresponder@med-vet.com",
    to: usuario.email,
    subject: "Redefinicao de Senha - Med-Vet",
    html: message
};
